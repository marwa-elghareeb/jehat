...
<section class="page-banner" style="background-size: 100% 100%; background-image: url('public/portal-assets/media/banner/top shape.png'); background-repeat: no-repeat; background-color: #7052fb;">
	<div class="container">
		<div class="page-title-wrapper">
			<h1 class="page-title" style="font-family: cairo"> الابراج الافتراضيه</h1>
			<ul class="bradcurmed">
      <li style="font-family: cairo"> الابراج الافتراضيه</li>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="team-member wow pixFadeRight" data-wow-delay="0.3s">
					<div class="member-avater"><img src="{{ asset('public\portal-assets\media\team\33.jpg')}}" 
          alt="avater" style="width: 470px; height : 386px ;">
						<ul class="member-social">
							<!--li><a><i class="fab fa-facebook-f"></i></a></li>
							<li><a><i class="fab fa-twitter"></i></a></li-->
							<li><a href="{{ URL :: to ('/allCompanies' )}}"><i class="fa fa-link"></i></a></li>
					...
					<div class="team-info">
          <h3 class="name">المكاتب الافتراضيه  </h3>
            ...
            <img src="{{ asset('public\portal-assets\media\team\22.png')}}" 
          alt="avater" style="width: 470px; height : 386px ;">
						<ul class="member-social">
							<!--li><a><i class="fab fa-facebook-f"></i></a></li>
							<li><a><i class="fab fa-twitter"></i></a></li-->
							<li><a><i class="fa fa-link"></i></a></li>
						</ul><svg class="layer-one" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="370px" height="210px">
							<path fill-rule="evenodd" opacity="0.302" fill="rgb(146, 112, 250)" d="M-0.000,79.999 C-0.000,79.999 85.262,-11.383 187.324,50.502 C297.703,117.429 370.000,-0.001 370.000,-0.001 L370.000,203.999 C370.000,207.313 367.314,209.999 364.000,209.999 L6.000,209.999 C2.686,209.999 -0.000,207.313 -0.000,203.999 L-0.000,79.999 Z">
							</path>
						</svg> <svg class="layer-two" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="370px" height="218px">
					...
					<h3 class="name">المعارض الافتراضيه </h3>
			...
			<div class="col-lg-4 col-md-6">
				<div class="team-member wow pixFadeRight" data-wow-delay="0.7s">
					<div class="member-avater">
            <img src="{{ asset('public\portal-assets\media\team\11.png')}}"
           alt="avater" style="width: 470px; height : 386px ;">
						<ul class="member-social">
							<!--li><a><i class="fab fa-facebook-f"></i></a></li>
							<li><a><i class="fab fa-twitter"></i></a></li-->
					...
					<div class="team-info">
          <h3 class="name">المتاجر الالكترونيه </h3>
...
<!--link rel="stylesheet" href="{{ asset('public\tower\card.css')}}">
      ...
      <div class="our_solution_category">
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title" >
              <h3 style="text-align: center ;">المكاتب الافتراضيه</h3>
            </div>
            <div class="solu_description">
              <p>
                يتم عرض جميع الشركات الموجوده فى المنصه وكذلك الاقسام الخاصه بها وايضا الموظفين
              </p>
              <button type="button" class="read_more_btn" > 
                <a href="{{ URL :: to ('/allCompanies' )}}">المزيد</a></button>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_title">
              <h3 style="text-align: center ;">المعارض الافتراضيه</h3>
            </div>
            <div class="solu_description">
              <p>
               يتم عرض جميع المعارض الموجود فى المنصه وتفاصيل كل معرض
              </p>
              <button type="button" class="read_more_btn">

              <a href="{{ URL :: to ('/allEvents' )}}">المزيد</a>
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3 style="text-align: center ;">المتاجر الالكترونيه</h3>
            </div>
            <div class="solu_description">
              <p>
                يتم العمل عليها فى الوقت الحالى وسيتم رفعها قريبا
              </p>
              <button type="button" class="read_more_btn">
