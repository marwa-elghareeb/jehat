            ...
            <section class="bg-grey parallax" data-background="assets/images/projectsbg.jpg">
                <div class="container">
                    <div class="section-heading title-style5">
                        <img alt="" src="{{ asset('public/tower/assets/images/logo2.png')}}" 
						style="margin-top: -45px; width: 35%;"><br>
                        <br>
                        <h3>مكاتب البرج</h3>
                        <div class="square">
