...
خطاباتي                                             <br>
                                ...
                                <div class="card">
								  ...
								  <div class="card">
                                    <div class="card-header" id="headingfiveed">
                                        <h2 class="mb-0">
                                            <a href="#" class="btn-link collapsed" data-toggle="collapse" data-target="#collapsefiveed" aria-expanded="false" aria-controls="collapsefiveed">احصائيات</a>
                                        </h2>
                                    </div>
                                    <div id="collapsefiveed" class="collapse" aria-labelledby="headingfiveed" data-parent="#accordionExample">
                                        <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseninee" class="collapse" aria-labelledby="headingninee" data-parent="#accordionExample">
                                        <div class="card-body">
											...
											<h4>عرض مواعيدي
											<br> 
											هي خانة تمكنك من عرض جميع مواعيدك المسجلة على منصة جهات وذلك من خلال الذهاب للصفحة الرئيسية ثم النقر عل أيقونة مكتبي ثم اختيار مواعيدي من قائمة المفكرة وستظهر فيها جميع المواعيد المسجلة مسبقا ويمكنك البحث عن موعد معين وذلك بتحديد التاريخ هجري أو ميلادي  ثم اختيار ايقونة عرض ويمكنك طباعة الموعد من خلال النقر على أيقونة طباعة.    
                                    ...
                                    <div id="collapseten" class="collapse" aria-labelledby="headingten" data-parent="#accordionExample">
                                        <div class="card-body">
											...
											<br> 
											  ...
											  للوصول لهذه الصفحة يجب الدخول على القائمة الرئيسية ومن ثم النقر على مكتبي ـ تظهرقائمة منسدلة  نقوم بالضغط على العملاء والاقسام  ثم بالضغط على المرفقات  تظهر صفحة  تستطيع من خلالها ارفاق مرفقات  العميل واختيار آسم وتاريخ المرفق ويمكن ادخالة بالتاريخ الهجري والميلادي ثم عرض.
								  ...
								  <div class="card">
                                    ...
                                    <div id="collapsetenn" class="collapse" aria-labelledby="headingtenn" data-parent="#accordionExample">
                                        <div class="card-body">
										 ...
										 <h4>كل الاجتماعات
											<br> 
											  من الدخول الى حسابك الشخصي والذهاب الى مكتبي ثم الانتقال الى الاجتماعات ثم الضغط على كل الاجتماعات عند اختيار كل الاجتماعات تظهر صفحة الاجتماعات مدرج بها كل الاجتماعات المدعو لها وبيانات الاجتماعات ( كود وعنوان ورئيس وتاريخ ووقت ونوع وحالة الاجتماع )  .. وفي حالة البحث عن اجتماع عند خانة البحث نكتب جزء من عنوان الاجتماع او عند الحالة تختار حالة الاجتماع لتسهيل الوصول اليه. عند اختيار الاجتماع المطلوب تظهر صفحة الاجتماع ويكون رئيس الاجتماع ومنسوبي الجهة والجهات الاخرى هم المسؤولين عن بدء الاجتماع او انهاؤه او الغاؤه وبدء التصويت ويمكنهم أيضا اضافة الاعضاء والبنود ويمكنهم رؤية الحضور والغياب في الاجتماع. تظهر في الصفحة ايضاً اعضاء الاجتماع يظهر الاسم باللون الاحمر اذا لم يحضر العضو الاجتماع وباللون الاخضر اذا حضر الاجتماع وايضاً اسفل الصفحة ايقونات الاجتماع اذا كنت عضو مدعو ( حضور الاجتماع ) واذا كنت منسوب جهه ( بدء الاجتماع - بدء التصويت - اضافة اعضاء - اضافة منسوب جهه - تعديل او اضافة بند - انهاء او الغاء الاجتماع - اضافة موظف ) وكمنسوب جهه ايضاً يمكنك تعديل عنوان او مقدمة الاجتماع بالضفط على ايقونة القلم. وللتصويت على بنود الاجتماع اسفل الصفحة الضغط على ايقونة تصويت عند البند ثم اختيار موافق او غير موافق ثم تصويت.
								  ...
								  <div class="card">
                                    ...
                                    <div id="collapsetennn" class="collapse" aria-labelledby="headintennn" data-parent="#accordionExample">
                                        <div class="card-body">
											...
											<h4> اضافة موظف
											<br> 
											بالدخول على حسابك والتوجه الى مكتبي والضغط على الموظفين ثم اضافة موظف تمكنك هذه الخانه من اضافة موظف عن طريق كتابة الهويه الوطنيه الخاصه بالموظف الذي تريد اضافته ثم الضغط على علامة البحث ثم اختيار الجهة التي تريد ادراج الموظف ثم الضغط على اضافة.
											...
											<h4>موظفين
											<br> 
											عند الدخول لحسابك الشخصي والتوجه الى خانة مكتبي ثم الضغط على الموظفين عند هذه الخانه ستظهر لك صفحة جميع الموظفين الذين تمت اضافتهم بالمنشئة مدرج فيها " اسم ورقم وكود " الموظف ايضاً انواع المعاملات الخاصة بالموظف والمستندات وبالضغط على ايقونة القلم يمكنك التعديل على بيانات الموظف وعند الضغط عليها تظهر لك بيانات العميل بها " مجموعات الموظفين - اسم الموظف باللغة العربية والانجليزية - جوال وبريد الموظف الالكتروني وهويته ورقم الكود " وعند جهات العمل بها جهة الموظف وعند المستفيد بها اسم المستفيد كامل وهويته. ومن أيقونة البحث يمكن البحث من خلالها عن الموظف بالاسم.
								  ...
								  <div class="card">
                                    ...
                                    <div id="collapsetennnn" class="collapse" aria-labelledby="headingtennnn" data-parent="#accordionExample">
                                        <div class="card-body">
                                          <h4> صلاحيات القوائم
											<br> 
											هي خانة تمكنك من وضع صلاحيات للقوائم أو الأفراد وذلك من خلال الذهاب للصفحة الرئيسية لجهات ثم النقر على أيقونة مكتبي ثم اختيار صلاحيات القوائم من قائمة الصلاحيات وستظهر لك صفحة تقوم فيها أولا بتحديد النوع إذا كان موظف أو مجموعة موظفين ثم تقوم بتحديد اسم الموظف  أو اسم القسم من القائمة المنسدلة وبعد ذلك ستظهر لك قائمة تقوم فيها بتحديد الصلاحيات  المرغوب تحديدها من المديولات ثم النقر على زر حفظ أسفل الصفحة.  
											...
											هي خانة تمكنك من وضع الصلاحيات للكنترول وذلك من خلال الذهاب للصفحة الرئيسية لجهات ثم النقر على أيقونة مكتبي ثم اختيار صلاحيات الكنترول من قائمة الصلاحيات وستظهر لك صفحة تقوم فيها بتحديد النوع سواء كان موظف أو مجموعة ثم تقوم بتحديد اسم الموظف أو اسم المجموعة.
