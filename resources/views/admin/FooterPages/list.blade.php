...
<!--**********************************
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('footer-pages-data.index') }}">list</a>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card button-card">
                    <div class="card-body">
                        <a href="{{ route('footer-pages-data.create') }}" 
                            ...
                            <table class="example display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('footer-pages-data.edit', $data->id ) }}" type="button" class="btn btn-rounded btn-secondary">
                                                <i class="fa fa-pencil color-secondary"></i> </a>
                                        </td>

                                        <td>

                                            <form method="POST" action="{{route('footer-pages-data.destroy', $data->id) }}">
                                                @method('DELETE')
